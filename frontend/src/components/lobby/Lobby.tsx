    ...
    <div className="max-w-4xl mx-auto">
      ...
      {gameId && isAuthenticated && (
        <div className="card mb-6 bg-blue-50 border-blue-200">
          <h2 className="text-2xl font-semibold mb-4 text-blue-900">Active Game</h2>
          <p className="text-blue-800 mb-4">
            You have an active game session. You can rejoin your game or start a new one.
          </p>
                  ...
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="text-right">
                      <p className="text-blue-800 font-medium">
                        {countdownInfo.playersReady}/{countdownInfo.totalPlayers} ready
                      </p>
              ...
              {isInQueue && !countdownInfo && (
                <div className="mt-4 p-3 bg-gray-50 rounded-lg">
                  <p className="text-gray-600 text-center">
                    Waiting for players... Game will start when enough players join
                  </p>
                </div>
              )}
            </>
