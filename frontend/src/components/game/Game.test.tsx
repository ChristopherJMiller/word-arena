...
describe('Game Component', () => {
  ...
  describe('loading and display states', () => {
    it('should show loading state when no game state exists', () => {
      ...
      expect(screen.getByText('Loading game state for test-game-123')).toBeInTheDocument();
    });
    ...
    it('should show loading spinner in reconnecting state', () => {
      ...
      const spinnerElement = screen.getByText('Reconnecting...').parentElement?.querySelector('.animate-spin');
