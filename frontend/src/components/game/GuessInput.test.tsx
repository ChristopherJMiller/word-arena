...
describe("GuessInput", () => {
  ...
  it("enables submit button only when word is complete", () => {
    const { rerender } = render(
      <GuessInput {...defaultProps} currentGuess="HELL" />,
    );
  ...
  it("calls onSubmit when Enter is pressed with complete word", () => {
    ...
    render(
      <GuessInput {...defaultProps} currentGuess="HELLO" onSubmit={onSubmit} />,
    );
  ...
  it("does not submit incomplete word", () => {
    const onSubmit = vi.fn();
    render(
      <GuessInput {...defaultProps} currentGuess="HEL" onSubmit={onSubmit} />,
    );
